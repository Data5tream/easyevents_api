    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_participants', models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(512, message='Events are currently limited to 512 participants max.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updates', to='core.event')),
